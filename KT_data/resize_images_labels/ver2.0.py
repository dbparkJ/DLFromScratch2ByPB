...
# 입력 폴더와 출력 폴더 경로 설정
input_folder_path = r"D:\de-identification\valid\valid_set"  # 입력 폴더 경로를 지정하세요.
output_folder_path = r"D:\de-identification\valid\valid_set\output"  # 출력 폴더 경로를 지정하세요.
